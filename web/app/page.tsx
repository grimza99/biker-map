...
export default function HomePage() {
  return (
    <PageWrapper className="p-7" innerClassName="gap-0">
      <p className="m-0 text-[13px] font-semibold uppercase tracking-[0.08em] text-accent">앱 착수</p>
      <h1 className="mt-2 max-w-[16ch] text-[clamp(30px,5vw,54px)] font-semibold leading-[1.02] tracking-[-0.04em] text-text">
