...
export function MapPanelFrame({
  ...
  return (
    <aside className="pointer-events-auto absolute inset-y-0 right-0 z-40 flex w-[min(26rem,100vw)] flex-col border-l border-border bg-bg/95 shadow-[-18px_0_48px_rgba(5,6,7,0.28)] backdrop-blur-xl">
